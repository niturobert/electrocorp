...
function PowerPlantMenu(props) {
    ...
    function addPowerPlant() {
        fetch('https://electrocorp-api.herokuapp.com/power_plant/create', {
            method: 'POST',
            body: JSON.stringify({
    ...
    useEffect(() => {
        fetch('https://electrocorp-api.herokuapp.com/power_plant/categories')
            .then(data => data.json())
            .then(data => {
...
function PylonMenu(props) {
    ...
    function addPylon() {
        fetch('https://electrocorp-api.herokuapp.com/pylon/create', {
            method: 'POST',
            body: JSON.stringify({
                token: Cookies.get('token', ''),
                name: name,
    ...
    useEffect(() => {
        fetch('https://electrocorp-api.herokuapp.com/pylon/categories')
            .then(data => data.json())
            .then(data => {
...
function PowerLine(props) {
    ...
    useEffect(async () => {
        await fetch('https://electrocorp-api.herokuapp.com/power_line/categories')
            .then(data => data.json())
            .then(data => {
                setPowerLineCategories(data.data)
            })

        await fetch('https://electrocorp-api.herokuapp.com/pylon/all', {
            method: 'POST',
        ...
        await fetch('https://electrocorp-api.herokuapp.com/power_plant/all', {
            method: 'POST',
            body: JSON.stringify({token: Cookies.get('token')}),
            cache: 'no-cache'
        })
        ...
        await fetch('https://electrocorp-api.herokuapp.com/power_cabin/all', {
            method: 'POST',
            body: JSON.stringify({token: Cookies.get('token')}),
            cache: 'no-cache'
        })
