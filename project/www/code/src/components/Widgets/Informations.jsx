...
export default function Informations(props) {
    ...
    async function deleteEntity() {
        switch (props.data.type) {
            case 'Power Plant':
                fetch('http://api.electrocorp.com/power_plant/' + props.data.id + '/delete', {
                    method: 'POST',
            ...
            case 'Pylon':
                fetch('http://api.electrocorp.com/pylon/' + props.data.id + '/delete', {
                    method: 'POST',
                    body: JSON.stringify({'token': Cookies.get('token')}),
                    cache: 'no-cache'
                })
            ...
            case 'Power Cabin':
                fetch('http://api.electrocorp.com/power_cabin/' + props.data.id + '/delete', {
                    method: 'POST',
                    body: JSON.stringify({'token': Cookies.get('token')}),
                    cache: 'no-cache'
                })
            ...
            case 'Power Line':
                fetch('http://api.electrocorp.com/power_line/' + props.data.id + '/delete', {
                    method: 'POST',
                    body: JSON.stringify({'token': Cookies.get('token')}),
                    cache: 'no-cache'
                })
