...
\input{Headers/CodeStructure.tex}
...
\thesistitle{Final Exam 2020-2021} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\degree{Information and Technology} % Your degree name, this is used in the title page and abstract, print it elsewhere with \degreename
...
\subject{Information and Technology} % Your subject area, this is not currently used anywhere in the template, print it elsewhere with \subjectname
